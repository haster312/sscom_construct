...
jQuery(document).ready(function($){
	...
	{
		//google map
		var coordinate = new google.maps.LatLng(16.0788274,108.1645216);
		var mapOptions = {
			zoom: 16,
			center: coordinate,
		...
		marker = new google.maps.Marker({
			...
			map: map,
			icon: new google.maps.MarkerImage("/assets/renovation/images/map_pointer.png", new google.maps.Size(38, 48), null, new google.maps.Point(18, 48))
		});
	}
