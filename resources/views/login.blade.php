...
<html lang="en">
	<head>
		...
		<!--[if lt IE 9]>
		<script type="text/javascript" src={{ url("admin/assets/js/libs/utils/html5shiv.js?1403934957"></script>
		<script type="text/javascript" src={{ url("admin/assets/js/libs/utils/respond.min.js?1403934956"></script>
		<![endif]-->
	</head>
	<body class="menubar-hoverable header-fixed ">
		...
		<section class="section-account">
			<div class="img-backdrop" style="background-image: url('admin/assets/img/img16.jpg')"></div>
